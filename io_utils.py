...
def parse_args(script):
    ...
    parser.add_argument('--train_ffs',  type=int, default=0)
    parser.add_argument('--train_n_way' , default=2, type=int,  help='class num to classify for training') #baseline and baseline++ would ignore this parameter
    parser.add_argument('--test_n_way'  , default=2, type=int,  help='class num to classify for testing (validation) ') #baseline and baseline++ only use this parameter in finetuning
